const Cart = ({cartlist}) => {
    ...
    return (
        <div className=" w-full md:w-1/4 ">
            ...
            <h1 className=" text-xl font-bold text-sky-600 pb-2 border-b-2">Credit Hour Remaining 20 hr</h1>
            ...
            <h1 className=" font-semibold py-2 border-b-2">Total Credit Hour : 13</h1>
